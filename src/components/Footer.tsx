      ...
      <div className="container mx-auto px-4 pt-16 pb-8">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8">
          <div className="md:col-span-4">
            <div className="flex items-center mb-6">
              <img src="/logo.png" alt="StackVibes Logo" className="h-10 w-auto" />
              <span className="ml-2 font-display font-bold text-xl">StackVibes</span>
            </div>
            <p className="text-gray-400 mb-6">
              Stacking Ideas. Vibing Innovation.
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-3">
              <li>
                <a href="mailto:ops@stackvibes.net" className="text-gray-400 hover:text-white transition-colors">
                  ops@stackvibes.net
                </a>
              </li>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <p className="text-gray-400 text-center">
            &copy; {currentYear} StackVibes. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
